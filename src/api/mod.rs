...
pub fn router(pool: SqlitePool) -> Router {
    Router::new()
        ...
        .route("/forms/{client_name}/{external_id}", delete(forms::delete_form))
        // Form definitions (client auth)
        .route("/definitions/{client_name}/{definition_id}", delete(definitions::delete_definition))
        // Admin token access
        ...
        // Public submit
        .route("/submit/{client_name}/{external_id}/token", get(submit::get_token))
